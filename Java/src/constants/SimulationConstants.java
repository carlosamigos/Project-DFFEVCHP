...
public class SimulationConstants {
    ...
    public final static double MEDIUM_ARRIVAL_RATE = 70.0;
    public final static double MEDIUM_RATE_LAMBDA = 1.0/MEDIUM_ARRIVAL_RATE;
    public final static double LOW_ARRIVAL_RATE = 200.0;
    ...
    public final static double PROBABILITY_CUSTOMERS_CHARGE = 0.5;
    public final static double CHARGING_TIME_FULL = 3*60; //3.5 hours, in minutes
