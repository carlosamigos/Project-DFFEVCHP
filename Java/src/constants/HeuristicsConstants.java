...
public class HeuristicsConstants {
    ...
    public final static int TABU_SIZE = 20;
    public final static int TABU_ITERATIONS = 2;
    ...
    public final static double TABU_IDEAL_STATE_UNIT_REWARD = 20;

    public final static double TABU_TRAVEL_COST = 0.01;
    
    //Punishes the size of operator list, relative to the travel time
    public final static double TABU_SIZE_OF_OPERATOR_LIST = 0.1;


    public final static double TABU_INTRA_MOVE_SIZE = 0.0*TABU_NEIGHBORHOOD_SIZE;
    public final static double TABU_INTER_MOVE_SIZE = 0.0*TABU_NEIGHBORHOOD_SIZE;
    public final static double TABU_INTER_2_SWAP_SIZE = 0.2*TABU_NEIGHBORHOOD_SIZE;
