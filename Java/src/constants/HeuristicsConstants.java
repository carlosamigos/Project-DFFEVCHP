...
public class HeuristicsConstants {
    ...
    public final static double TABU_CHARGING_UNIT_REWARD = 5;
    ...
    public final static double TABU_IDEAL_STATE_UNIT_REWARD = 1;
    ...
    public final static double TABU_EJECTION_INSERT_SIZE = 0.1*TABU_NEIGHBORHOOD_SIZE;
