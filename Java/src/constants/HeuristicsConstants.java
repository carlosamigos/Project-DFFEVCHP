...
public class HeuristicsConstants {
    ...
    public final static double TABU_SIZE_OF_OPERATOR_LIST = 0.01;
    //------
    ...
    public final static double TABU_INTRA_MOVE_SIZE = 0.5*TABU_NEIGHBORHOOD_SIZE;
    public final static double TABU_INTER_MOVE_SIZE = 0.5*TABU_NEIGHBORHOOD_SIZE;
    public final static double TABU_INTER_2_SWAP_SIZE = 0.85*TABU_NEIGHBORHOOD_SIZE;
    public final static double TABU_EJECTION_REPLACE_SIZE = 0.05*TABU_NEIGHBORHOOD_SIZE;
    public final static double TABU_EJECTION_REMOVE_SIZE = 0.0*TABU_NEIGHBORHOOD_SIZE;
