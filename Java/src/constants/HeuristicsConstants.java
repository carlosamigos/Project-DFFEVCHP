...
public class HeuristicsConstants {
    ...
    // Mosel Cost Parameters
    public final static double COST_OF_POSTPONED_CHARGING = 40;
    ...
    public final static double TABU_EJECTION_INSERT_SIZE = 0.3*TABU_NEIGHBORHOOD_SIZE;
