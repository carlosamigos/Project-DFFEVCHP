...
public class HeuristicsConstants {
    ...
    public final static double ALNS_FOUND_NEW_GLOBAL_BEST_REWARD = 13.0; //10.0
    public final static double ALNS_UPDATE_FACTOR = 0.2; //0.5
    ...
    public final static double ALNS_FOUND_NEW_GLOBAL_BEST_REWARD_LNS = 13.0; //2.0
    public final static double ALNS_DESTROY_FACTOR = 0.4;
    public final static double ALNS_UPDATE_FACTOR_LNS = 0.2; //0.5
